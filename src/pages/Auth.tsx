                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      ...
                      className={`p-4 rounded-xl border-2 transition-all flex flex-col items-center gap-2 ${userType === "buyer" ? "border-primary bg-primary/10" : "border-border hover:border-primary/50"
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`p-4 rounded-xl border-2 transition-all flex flex-col items-center gap-2 ${userType === "seller" ? "border-primary bg-primary/10" : "border-border hover:border-primary/50"
                        }`}
                    >
